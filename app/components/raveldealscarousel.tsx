    ...
    <section className="overflow-hidden bg-background py-12 sm:py-16 lg:py-20">
      <div className="mx-auto w-full max-w-[1600px] px-4 sm:px-6 lg:px-10 xl:px-16">
        ...
        <div
          ...
          className="-mx-4 flex snap-x snap-mandatory gap-5 overflow-x-auto px-4 py-6 pb-6 scroll-smooth [scrollbar-width:none] sm:-mx-6 sm:gap-6 sm:px-6 lg:mx-0 lg:gap-7 lg:px-0 [&::-webkit-scrollbar]:hidden"
        >
          {deals.map((deal) => (
